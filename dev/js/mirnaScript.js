$(document).ready(function() {
   ...
   $("#submit").click(function() {
      ...
      var email = $("#email").val();
      if (inputFasta == '') {
         inputFasta = $('#inputFasta').attr('placeholder');
      ...
      if (validateFasta(inputFasta) == false) {
         $('#inputFasta').css("background-color", "rgba(200,0,0,0.2)");
         $('#resultDiv').append("<center><h4 style=\"color: red;\">Please check your fasta input<h4><center>");
      } else {
         ...
         if (i < 1) {
            ...
            $('#resultDiv').append("<center><h4 style=\"color: red;\">Please select features that you want to calculate<h4><center>");
            return false;
         }
         if (email == "") {
            $("#email").css('background-color', 'rgba(200,0,0,0.2)');
            $('#resultDiv').append("<center><h4 style=\"color: red;\">Please provide an e-mail address<h4><center>");
            return false;
         }
         while (i--) {
